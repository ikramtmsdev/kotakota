		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapuisearchservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuisearchservice-display": {
								"semanticObject": "sapuisearchservice",
								"action": "display",
								"description": "Search service app",
								"title": "Search Service",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.searchservice",
									"url": sap.ui.require.toUrl("sap/ui/searchservice")
								}
							}
						}
					}
