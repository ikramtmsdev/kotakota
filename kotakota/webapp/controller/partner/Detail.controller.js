sap.ui.define([
    ...
    function (
        ...
        return BaseController.extend("sap.ui.kotakota.controller.partner.Detail", {
            formatter: formatter,

            onInit: async function () {
                this.oRouter = this.getOwnerComponent().getRouter();
                this.oRouter.getRoute("PartnerDetail").attachPatternMatched(this._onPatternMatched, this);
                this.bindingElement();
            },
            ...
            _onPatternMatched: async function (oEvent) {
                ...
                oView = this.getView();
                oView.setBusy(true);
                var Partner = await this.AjaxGetData("Partner/" + ID);
                var oPartner = new JSONModel(Partner);
                this.getView().setModel(oPartner);
                oView.bindElement({
                    path: "/"
                });
                oView.setBusy(false);
            ...
            onEdit: function (oEvent) {
                ...
                this.getView().byId('PenjualID').setEditable(true);
            ...
            postData: async function () {
                ...
                try {
                    await this.AjaxPatchData("Partner/" + ID, patch);
