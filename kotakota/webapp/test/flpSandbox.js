		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Kotakota",
									"targetURL": "#sapuikotakota-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuikotakota-display": {
								"semanticObject": "sapuikotakota",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.kotakota",
									"url": sap.ui.require.toUrl("sap/ui/kotakota")
								}
							}
						}
					}
